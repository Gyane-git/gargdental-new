        ...
        {mappedVariations.map((product, idx) => (
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              <img
                src={product.main_image_full_url || product.image_full_url}
                alt={product.product_name}
                className="w-14 h-14 sm:w-16 sm:h-16 object-contain rounded-lg border border-gray-200 bg-white flex-shrink-0"
              />
