  ...
  const getBanner = async () => {
    try {
      ...
      if (data.success) {
        ...
        if (data.banner.image_full_url) {
          setDesktopPreview(data.banner.image_full_url);
        }
        if (data.banner.mobile_image_full_url) {
          setMobilePreview(data.banner.mobile_image_full_url);
        }
      } else {
