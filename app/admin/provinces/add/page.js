    ...
    <div className="flex min-h-screen flex-col bg-[#eef2f9] font-sans text-[#3b4256]">
      <div className="flex flex-1 items-start justify-center px-4 py-12 sm:py-16">
        <div className="w-full max-w-[500px] rounded-[10px] bg-white p-8 shadow-[0_2px_10px_rgba(30,42,80,0.06)] sm:p-10">
          <h1 className="mb-8 text-center text-2xl font-semibold text-[#232f4b]">Add Province Details</h1>
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-1">
            <div>
              ...
              <div className="relative">
                <input type="text" name="province" value={form.province} onChange={handleChange("province")} placeholder="Enter province" className="w-full rounded-md border border-[#e1e4eb] bg-white px-3 py-2.5 text-[15px] text-[#3b4256] transition-all duration-200 focus:border-[#2f55d4] focus:outline-none focus:ring-4 focus:ring-[#2f55d4]/20" />
              </div>
            </div>
          </div>
