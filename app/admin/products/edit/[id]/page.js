                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute top-1.5 right-1.5 w-6 h-6 flex items-center justify-center bg-black/60 hover:bg-black text-white rounded-full transition disabled:opacity-60"
                            title="Remove image"
                          >
                            <X size={14} />
                          </button>
