        ...
        <div className="flex flex-col gap-6">
          ...
          <Section icon={Package} title="Basic Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <Field label="Product Code" hint="Auto-generated">
                <input value={form.product_code} placeholder="Auto-generated" disabled className={`${inputCls} cursor-not-allowed bg-gray-500 text-gray-500`} />
              </Field>
          ...
          <Section icon={Upload} title="Gallery Images">
            <div className="space-y-4">
              <div onClick={() => document.getElementById("gallery-images-input")?.click()} className="cursor-pointer rounded-xl border-2 border-dashed border-gray-200 hover:border-blue-300 transition p-5 flex flex-col items-center gap-2 text-gray-400">
                <Upload size={22} className="text-gray-300" />
                <p className="text-sm font-medium text-gray-500 text-center">Upload one or more product images</p>
                <p className="text-xs text-gray-400">JPG, PNG, WEBP up to 5MB each</p>
              </div>
              <input id="gallery-images-input" type="file" accept="image/*" multiple className="hidden" onChange={handleGalleryImages} />
